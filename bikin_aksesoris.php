...
<body class="bg-gray-100 text-gray-900 pt-24 px-8 pb-8 font-mono">
    ...
    <form action="bikin_aksesoris.php" method="post" class="bg-white p-8 shadow-lg">
        <div class="mb-4">
        ...
        <div class="flex items-center justify-start space-x-4">
            ...
            <a href="daftar_aksesoris.php" class="inline-block align-baseline font-semibold text-sm text-blue-600 hover:text-blue-800">
                Cancel
            </a>
        </div>
    </form>
