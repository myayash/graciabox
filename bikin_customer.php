...
<body class="bg-gray-100 text-gray-900 pt-24 px-8 pb-8 font-mono">
    ...
    <form action="bikin_customer.php" method="post" class="bg-white p-8 shadow-lg">
        ...
        <div class="flex items-center justify-start space-x-4">
            <input type="submit" value="Add Customer" class="bg-blue-600 hover:bg-blue-700 text-white font-bold py-2 px-4 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition duration-150 ease-in-out">
