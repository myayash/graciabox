...
<body class="bg-gray-100 text-gray-900 pt-24 px-8 pb-8 font-mono">
    ...
    <h1 class="text-2xl font-bold mb-6 text-gray-800">Add New Model Box</h1>

    <form action="bikin_model_box.php" method="post" class="bg-white p-8 shadow-lg">
        <div class="mb-4">
        ...
        <div class="flex items-center justify-start space-x-4">
            <input type="submit" value="Add Model Box" class="bg-blue-600 hover:bg-blue-700 text-white font-bold py-2 px-4 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition duration-150 ease-in-out">
            <a href="daftar_model_box.php" class="inline-block align-baseline font-semibold text-sm text-blue-600 hover:text-blue-800">
                Cancel
            </a>
        </div>
    </form>
