...
<body class="bg-gray-100 text-gray-900 pt-24 px-8 pb-8">
    ...
    <h1 class="text-xl sm:text-2xl font-bold mb-6 text-gray-800">tambah data karyawan sales</h1>

    <form action="<?php echo BASE_URL; ?>/bikin_karyawan_sales" method="post" class="bg-white p-8 shadow-md rounded-lg max-w-md mx-auto">
        <div class="mb-4">
