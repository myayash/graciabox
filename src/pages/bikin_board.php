...
<body class="bg-gray-100 text-gray-900 pt-24 px-8 pb-8">
    ...
    <h1 class="text-xl sm:text-2xl font-bold mb-6 text-gray-800">tambah jenis board</h1>

    <form action="<?php echo BASE_URL; ?>/bikin_board" method="post" class="bg-white p-8 shadow-md rounded-lg max-w-md mx-auto">
        <div class="mb-4">
        ...
        <div class="flex items-center justify-start space-x-4">
            ...
            <a href="<?php echo BASE_URL; ?>/daftar_board" class="inline-block align-baseline font-semibold text-sm text-blue-600 hover:text-blue-800">
                Cancel
            </a>
        </div>
    </form>
