...
<h1 class="text-2xl font-bold mb-6 text-gray-800 flex items-center">
    ...
    <div class="inline-flex">
        <?php if (isset($_GET['show_archived']) && $_GET['show_archived'] == 'true'): ?>
            <a href="daftar_spk_logo" class="ml-2 px-4 py-2 bg-gray-600 text-white font-bold hover:bg-gray-700 transition duration-150 ease-in-out">Active SPK Logo</a>
        <?php else: ?>
            <a href="daftar_spk_logo?show_archived=true" class="ml-2 px-4 py-2 bg-gray-600 text-white font-bold hover:bg-gray-700 transition duration-150 ease-in-out">Archived SPK Logo</a>
        <?php endif; ?>
    </div>
    <a href="daftar_spk" class="ml-auto px-4 py-2 bg-blue-600 text-white font-bold hover:bg-blue-700 transition duration-150 ease-in-out">SPK Dudukan</a>
    <?php endif; ?>
</h1>

<form action="daftar_spk_logo" method="get" class="mb-4">
