...
<body class="bg-gray-100 text-gray-900 pt-24 px-8 pb-8 font-mono">
    ...
    <h1 class="text-2xl font-bold mb-6 text-gray-800">tambah aksesoris</h1>

    <form action="<?php echo BASE_URL; ?>/bikin_aksesoris" method="post" class="bg-white p-8 shadow-lg">
        <div class="mb-4">
