...
if ($_SESSION['role'] !== 'admin') {
    die('Access Denied: You do not have permission to add new dudukan.');
}
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (!empty($jenis)) {
        ...
        echo "<p class=\"mt-4 text-red-600\">Please fill in all required fields (Jenis).</p>";
    }
}
?>
...
<body class="bg-gray-100 text-gray-900 pt-24 px-8 pb-8">
    ...
    <h1 class="text-xl sm:text-2xl font-bold mb-6 text-gray-800">tambah dudukan</h1>

    <form action="bikin_dudukan" method="post" class="bg-white p-8 shadow-md rounded-lg max-w-md mx-auto">
        <div class="mb-4">
