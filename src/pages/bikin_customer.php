...
<body class="bg-gray-100 text-gray-900 pt-24 px-8 pb-8">
    ...
    <h1 class="text-xl sm:text-2xl font-bold mb-6 text-gray-800">tambah customer</h1>

    <form action="<?php echo BASE_URL; ?>/bikin_customer" method="post" class="bg-white p-8 shadow-md rounded-lg max-w-md mx-auto">
        <div class="mb-4">
        ...
        <div class="mb-4">
            ...
            <input type="text" name="perusahaan" id="perusahaan" class="appearance-none bg-white border border-gray-300 w-full py-2 px-3 text-gray-800 leading-tight focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition duration-150 ease-in-out rounded-md">
        </div>

        <div class="mb-4">
            <label for="no_telp" class="block text-gray-800 text-sm font-semibold mb-2">No. Telepon:</label>
            <input type="text" name="no_telp" id="no_telp" class="appearance-none bg-white border border-gray-300 w-full py-2 px-3 text-gray-800 leading-tight focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition duration-150 ease-in-out rounded-md" required>
        </div>
        ...
        <div class="flex items-center justify-start space-x-4">
            ...
            <a href="<?php echo BASE_URL; ?>/daftar_customer" class="inline-block align-baseline font-semibold text-sm text-blue-600 hover:text-blue-800">
                Cancel
            </a>
        </div>
    </form>
