...
<h1 class="text-2xl font-bold mb-6 text-gray-800">daftar board
    <?php if (isset($_SESSION['role']) && $_SESSION['role'] === 'admin'): ?>
    <div class="inline-flex ml-4">
        <a href="bikin_board" class="px-4 py-2 bg-blue-600 text-white font-bold hover:bg-blue-700 transition duration-150 ease-in-out">+ Board</a>
        <?php if (isset($_GET['show_archived']) && $_GET['show_archived'] == 'true'): ?>
            <a href="daftar_board" class="ml-2 px-4 py-2 bg-gray-600 text-white font-bold hover:bg-gray-700 transition duration-150 ease-in-out">Active Board</a>
        <?php else: ?>
            <a href="daftar_board?show_archived=true" class="ml-2 px-4 py-2 bg-gray-600 text-white font-bold hover:bg-gray-700 transition duration-150 ease-in-out">Archived Board</a>
        <?php endif; ?>
    </div>
    <?php endif; ?>
</h1>

<form action="daftar_board" method="get" class="mb-4">
