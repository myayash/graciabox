...
<h1 class="text-2xl font-bold mb-6 text-gray-800">daftar dudukan
    <?php if (isset($_SESSION['role']) && $_SESSION['role'] === 'admin'): ?>
    <div class="inline-flex ml-4">
        <a href="bikin_dudukan" class="px-4 py-2 bg-blue-600 text-white font-bold hover:bg-blue-700 transition duration-150 ease-in-out">+ Dudukan</a>
        <?php if (isset($_GET['show_archived']) && $_GET['show_archived'] == 'true'): ?>
            <a href="daftar_dudukan" class="ml-2 px-4 py-2 bg-gray-600 text-white font-bold hover:bg-gray-700 transition duration-150 ease-in-out">Active Dudukan</a>
        <?php else: ?>
            <a href="daftar_dudukan?show_archived=true" class="ml-2 px-4 py-2 bg-gray-600 text-white font-bold hover:bg-gray-700 transition duration-150 ease-in-out">Archived Dudukan</a>
        <?php endif; ?>
    </div>
    <?php endif; ?>
</h1>

<form action="daftar_dudukan" method="get" class="mb-4">
    <input type="text" name="search" placeholder="cari data dudukan" value="<?php echo htmlspecialchars($_GET['search'] ?? ''); ?>" class="p-2 border border-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-500">
