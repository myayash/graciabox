...
<body class="bg-gray-100 text-gray-900 pt-24 px-8 pb-8 font-mono">
    ...
    <h1 class="text-2xl font-bold mb-6 text-gray-800">daftar dudukan
        ...
        <div class="inline-flex ml-4">
            <a href="bikin_dudukan.php" class="px-4 py-2 bg-blue-600 text-white font-bold hover:bg-blue-700 transition duration-150 ease-in-out">+ Dudukan</a>
            <?php if (isset($_GET['show_archived']) && $_GET['show_archived'] == 'true'): ?>
                <a href="daftar_dudukan.php" class="ml-2 px-4 py-2 bg-gray-600 text-white font-bold hover:bg-gray-700 transition duration-150 ease-in-out">Active Dudukan</a>
            <?php else: ?>
                <a href="daftar_dudukan.php?show_archived=true" class="ml-2 px-4 py-2 bg-gray-600 text-white font-bold hover:bg-gray-700 transition duration-150 ease-in-out">Archived Dudukan</a>
            <?php endif; ?>
        </div>
        <?php endif; ?>
    </h1>

    <form action="daftar_dudukan.php" method="get" class="mb-4">
    ...
    if (isset($_GET['archive_id']) && !empty($_GET['archive_id'])) {
        ...
        try {
            ...
            header("Location: daftar_dudukan.php"); // Redirect to refresh the page
            exit;
    ...
    if (isset($_GET['unarchive_id']) && !empty($_GET['unarchive_id'])) {
        ...
        try {
            ...
            header("Location: daftar_dudukan.php?show_archived=true"); // Redirect to refresh the page, staying on archived view
            exit;
        } catch (PDOException $e) {
