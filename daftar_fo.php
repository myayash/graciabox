...
<body class="bg-gray-100 text-gray-900 pt-24 px-8 pb-8 font-mono">
    ...
    <h1 class="text-2xl font-bold mb-6 text-gray-800">Order Information
        <div class="inline-flex ml-4">
            <a href="bikin_fo.php" class="px-4 py-2 bg-blue-600 text-white font-bold hover:bg-blue-700 transition duration-150 ease-in-out">Create New Order</a>
            <?php if (isset($_GET['show_archived']) && $_GET['show_archived'] == 'true'): ?>
                <a href="daftar_fo.php" class="ml-2 px-4 py-2 bg-gray-600 text-white font-bold hover:bg-gray-700 transition duration-150 ease-in-out">Show Active Orders</a>
            <?php else: ?>
                <a href="daftar_fo.php?show_archived=true" class="ml-2 px-4 py-2 bg-gray-600 text-white font-bold hover:bg-gray-700 transition duration-150 ease-in-out">Show Archived Orders</a>
            <?php endif; ?>
        </div>
    </h1>
